...
class Test(testlib.TestCase):
    def do_test(self, tabella1, tabella2, col, expected, expectedTab):
        ...
        self.assertEqual(
            tabella1, expectedTab, "La tabella1 non è stata modificata correttamente"
        )
    ...
    @data(
        ...
        (
            [{"C1": 1, "C2": "x"}, {"C1": 2, "C2": "a"}, {"C1": 3, "C2": "a"}],
            [{"C1": 3, "C2": "b"}, {"C1": 4, "C2": "b"}, {"C1": 5, "C2": "a"}],
            "C1",
            2,
            [
                {"C1": 1, "C2": "x"},
