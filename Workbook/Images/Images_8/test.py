...
class Test(testlib.TestCase):
    ...
    @data(
        ...
        (
            500,
            [
                (361, 88, 132, 148, 202, 114),
                (309, 346, 213, 26, 7, 162),
                (279, 234, 219, 157, 147, 255),
                (119, 238, 51, 78, 143, 144),
                (421, 156, 234, 87, 148, 121),
                (257, 423, 250, 41, 100, 23),
                (486, 312, 209, 254, 210, 218),
                (456, 90, 220, 235, 211, 4),
                (424, 191, 120, 192, 201, 241),
                (169, 419, 239, 221, 134, 61),
                (121, 4, 200, 228, 158, 69),
                (238, 377, 163, 35, 225, 225),
                (74, 259, 84, 166, 98, 8),
                (283, 369, 195, 234, 249, 13),
                (22, 270, 104, 153, 242, 170),
                (329, 259, 75, 216, 232, 64),
                (256, 432, 178, 98, 147, 44),
                (453, 262, 197, 150, 105, 98),
                (323, 205, 117, 158, 53, 204),
                (136, 185, 139, 245, 141, 234),
            ],
            "out3.png",
            89517,
            "risTest2c.png",
