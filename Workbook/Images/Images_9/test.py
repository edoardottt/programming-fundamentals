...
class Test(testlib.TestCase):
    def do_test(
        self, filePng, centro, spessore, colori, pngFileOut, expected, expectedPng
    ):
        ...
        with self.ignored_function("builtins.print"), self.forbidden_function(
            ...
            result = program.es74(filePng, centro, spessore, colori, pngFileOut)
        self.assertEqual(
    ...
    @data(
        ...
        (
            ...
            "test.92.png",
            [305, 940, 1564, 2204, 2812, 3452, 4084, 4708, 5364, 5048],
            "expected.92.png",
        ),
    )
    @unpack
    def test(
        ...
        return self.do_test(
            filePng, centro, spessore, colori, pngFileOut, expected, expectedPng
        )
