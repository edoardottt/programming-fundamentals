...
class Test(testlib.TestCase):
    ...
    @data(
        (
            ...
            [
                "t2Copy/paperino.jpg",
                "t2Copy/u1/topolino.txt",
                "t2Copy/u1/v2/w3/topolino.txt",
                "t2Copy/u2/v1/w4/x3/minnie.png",
                "t2Copy/u3/v2/minnie.txt",
                "t2Copy/u3/v1/w1/minnie.txt",
            ],
            ["t2Copy/u1/v3/w1/paperino.jpg", "t2Copy/u2/v1/w4/minnie.png"],
        )
    )
    @unpack
