...
class Test(testlib.TestCase):
    ...
    def test_1(self):
        ...
        expected = [
            ...
            [
                "h",
                ["c", ["a", None, None], ["f", None, None]],
                ["j", ["g", None, None], ["k", None, None]],
            ],
            ["m", ["k", None, None], ["p", ["m", None, None], ["q", None, None]]],
        ]
    ...
    def test_2(self):
        ...
        expected = [
            ...
            [
                "H",
                ["B", None, ["F", ["C", None, None], None]],
                ["S", ["N", ["J", None, None], ["O", None, None]], ["T", None, None]],
            ],
            ["W", None, ["Z", ["Y", None, None], None]],
        ]
        return self.do_test(percorsi, expected)
        ...
        expected = [
            ...
            [
                ...
                [
                    ...
                    [
                        "u",
                        ["t", ["p", None, ["q", None, ["r", None, None]]], None],
                        ["v", None, ["w", None, None]],
                    ],
                    None,
                ],
