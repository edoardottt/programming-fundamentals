...
class Immagine():
    ...
    def __str__(self):
        return 'Immagine(h = {}, l = {}, sfondo = {})'.format(self.altezza, self.larghezza, self.colore_sfondo)
    ...
    def disegna_rettangolo(self, rettangolo, colore):
        ...
        for y in range(rettangolo.vertice_as.y,
                          rettangolo.vertice_bs.y+1):
            for x in range(rettangolo.vertice_as.x,
                               rettangolo.vertice_ad.x+1):
                self.imm[y][x] = colore
